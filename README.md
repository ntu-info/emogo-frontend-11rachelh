...
data collected (time, coordinates, notes, sentiment: exported to json file； selfie sceenshot, vlog mp4: saved to local album): https://drive.google.com/drive/folders/1iItLPR_rhiOAqyMB0c9FsyA-b4s584cY?usp=sharing
